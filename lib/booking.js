 ...
 */
export function hasBookableTime(doctor, date, slotMinutes = APPOINTMENT_LIMITS.defaultSlotMinutes, now = new Date(), rules = APPOINTMENT_LIMITS) {
  ...
  const earliestStart = now.getHours() * 60 + now.getMinutes() + rules.minLeadMinutes;
